...
<form id="kunden_edit_form" method="post" action="{{route('kunden.update',$kunden->id)}}">
    ...
    <div class="container" style="padding-top:10px; background-color: #fff;">
        <div class="panel-heading">
            <h2>{{ $kunden->vorname }} {{ $kunden->nachname }} bearbeiten</h2>
        </div>
        <hr />
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-2" id="finanzierungsbedarf">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="kaufpreis" id="kaufpreis" placeholder="0.00" value="{{ stringReplace($kunden->kaufpreis, '.', ',') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="kostenumbau" id="kostenumbau" placeholder="0.00" value="{{ stringReplace($kunden->kostenumbau, '.', ',') }}">
                        <div class="input-group-append">
                            <span class="input-group-text">€</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="kostennotar" id="kostennotar" placeholder="{{ stringReplace($kunden->kostennotar, '.', ',') }}" value="{{ stringReplace(number_format($kunden->kostennotar, 1, '.', ','), '.', ',') }}">
                        <div class="input-group-append">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="grunderwerbssteuer" id="grunderwerbssteuer" placeholder="{{ stringReplace($kunden->grunderwerbssteuer, '.', ',') }}" value="{{ stringReplace(number_format($kunden->grunderwerbssteuer, 1, '.', ','), '.', ',') }}">
                        <div class="input-group-append">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="maklerkosten" id="maklerkosten" placeholder="0.00" value="{{ stringReplace(number_format($kunden->maklerkosten, 1, '.', ','), '.', ',') }}">
                        <div class="input-group-append">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="gesamtkosten" id="gesamtkosten" placeholder="0.00" value="{{ stringReplace($kunden->gesamtkosten, '.', ',')  }}" readonly="">
                        <div class="input-group-append">
                            <span class="input-group-text">€</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="eigenkapital" id="eigenkapital" placeholder="0.00" value="{{ stringReplace($kunden->eigenkapital, '.', ',') }}">
                        <div class="input-group-append">
                            <span class="input-group-text">€</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-right" name="finanzierungsbedarf" placeholder="0.00" value="{{ stringReplace($kunden->finanzierungsbedarf, '.', ',') }}" readonly="">
                        <div class="input-group-append">
                            <span class="input-group-text">€</span>
                        </div>
                    </div>
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="vorname" id="vorname" placeholder="{{ $kunden->vorname }}" value="{{ $kunden->vorname }}">
                </div>
                <div class="form-group">
                    <label for="nachname">Nachname</label>
                    <input type="text" class="form-control" name="nachname" id="nachname" placeholder="{{ $kunden->nachname }}" value="{{ $kunden->nachname }}">
                </div>

                <div class="form-group">
                    <label for="strasse">Straße</label>
                    <input type="text" class="form-control" name="strasse" id="strasse" placeholder="{{ $kunden->strasse }}" value="{{ $kunden->strasse }}">
                </div>

                <div class="form-group">
                    <label for="plz">PLZ</label>
                    <input type="number" class="form-control" name="plz" id="plz" placeholder="{{ $kunden->plz }}" value="{{ $kunden->plz }}">
                </div>

                <div class="form-group">
                    <label for="wohnort">Wohnort</label>
                    <input type="text" class="form-control" name="wohnort" id="wohnort" placeholder="{{ $kunden->wohnort }}" value="{{ $kunden->wohnort }}">
                </div>

                <div class="form-group">
                    <label for="mail">Mail</label>
                    <input type="mail" class="form-control" name="mail" id="mail" placeholder="{{ $kunden->mail }}" value="{{ $kunden->mail }}">
                </div>

                <div class="form-group">
                    <label for="telefon">Telefon</label>
                    <input type="text" class="form-control" name="telefon" id="telefon" placeholder="{{ $kunden->telefon }}" value="{{ $kunden->telefon }}">
                </div>

                <div class="form-group">
                    <label for="geburtsdatum">Geburtsdatum</label>
                    <input type="date" class="form-control" name="geburtsdatum" id="geburtsdatum" placeholder="{{ $kunden->geburtsdatum }}" value="{{ $kunden->geburtsdatum }}">
                </div>
                <div class="form-group">
                ...
                <div id="spouseDiv" style="display: {{$spouseDivShown}}">
                    ...
                    <div class="form-group">
                        <label class="col-form-label" for="vorname">Vorname</label>
                        <input type="text" class="form-control" name="ehepartner_vorname" id="ehepartner_vorname" placeholder="{{ $kunden->ehepartner_vorname }}" value="{{ $kunden->ehepartner_vorname }}">
                    </div>
                    <div class="form-group">
                        <label for="nachname">Nachname</label>
                        <input type="text" class="form-control" name="ehepartner_nachname" id="ehepartner_nachname" placeholder="{{ $kunden->ehepartner_nachname }}" value="{{ $kunden->ehepartner_nachname }}">
                    </div>
                    <div class="form-group">
                        <label for="mail">Mail</label>
                        <input type="mail" class="form-control" name="ehepartner_mail" id="ehepartner_mail" placeholder="{{ $kunden->ehepartner_mail }}" value="{{ $kunden->ehepartner_mail }}">
                    </div>
                    <div class="form-group">
                        <label for="telefon">Telefon</label>
                        <input type="text" class="form-control" name="ehepartner_telefon" id="ehepartner_telefon" placeholder="{{ $kunden->ehepartner_telefon }}" value="{{ $kunden->ehepartner_telefon }}">
                    </div>
                    <div class="form-group">
                        <label for="geburtsdatum">Geburtsdatum</label>
                        <input type="date" class="form-control" name="ehepartner_geburtsdatum" id="ehepartner_geburtsdatum" placeholder="{{ $kunden->ehepartner_geburtsdatum }}" value="{{ $kunden->ehepartner_geburtsdatum }}">
                    </div>
...
<script>
    $(document).ready(function() {
        var Annuitaeten = {
            ...
            zinssatz: function() {
                var zinssatzField = document.getElementById('borrowing_rate').value;
                var zinssatz = zinssatzField;
                if (zinssatzField.toString().includes(".")) {
                    zinssatzField = parseFloat(zinssatzField.toString());
                }
                if (zinssatzField.toString().includes(",")) {
                    zinssatzField = parseFloat(zinssatzField.replace(',', "."));
                }
                if (zinssatzField >= 100) {
                    zinssatz = parseFloat(zinssatzField);
                }
                if (zinssatzField >= 10) {
                    zinssatz = parseFloat("0." + zinssatzField.toString());
                }
                if (zinssatzField < 10 && zinssatzField > 0) {
                    zinssatz = parseFloat("0.0" + zinssatzField.toString());
                }
                return zinssatz;
            },
            zinsbindung: function() {
                var zinsbindung = parseInt(document.getElementById('loan_period').value);
                return zinsbindung;
            },
            annuitaet: function() {
                var laufzeit = Annuitaeten.zinsbindung();
                var zinssatz = Annuitaeten.zinssatz();
                var zinsStr = "1" + zinssatz.toString().replace("0.", ".");
                var zinsPlus1 = parseFloat(zinsStr);
                var annuitaet = ((Math.pow(zinsPlus1, laufzeit)) * zinssatz) / ((Math.pow(zinsPlus1, laufzeit)) - 1);
                return annuitaet;
            },
            kreditsumme: function() {
                var y = document.getElementById("loan_amount").value.replace(',', '.').replace('.00', '').replace(',00', '');
                var kreditsumme = parseFloat(y.replace('.', ''));
                return kreditsumme;
            },
            monatlicheAnnuitaet: function() {

                var sum = Annuitaeten.kreditsumme() * Annuitaeten.annuitaet() / 12;
                var monatlicheAnnuitaet = parseFloat(sum.toFixed(2));

                console.log("Monatliche Annuität: " + sum.toFixed(2).toString().replace(".", ",") + " €");
                return monatlicheAnnuitaet;
            },
            jaehrlicheAnnuitaet: function() {
                var sum = Annuitaeten.kreditsumme() * Annuitaeten.annuitaet();
                var jaehrlicheAnnuitaet = parseFloat(sum.toFixed(2));

                console.log("Jährliche Annuität: " + sum.toFixed(2).toString().replace(".", ",") + " €");
                return jaehrlicheAnnuitaet;
            },
            changeToMonth: function() {
                setTimeout(function() {
                    document.getElementById('montly_deposit_val').value = Annuitaeten.monatlicheAnnuitaet().toString().replace('.', ',');
                }, 1000);
            }
        }
        ...
        function s() {
            document.getElementById('new_borrowing_rate').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('new_rate_inp').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('new_repayment_rate_inp').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('onetime_unsheduled_val').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('sparsumme').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('laufzeit').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('message_payment_opt').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('montly_deposit_val').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('repayment_date_inp').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('payment_year').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('borrowing_rate').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('payment_month').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('loan_period').addEventListener('input', Annuitaeten.changeToMonth);
            document.getElementById('loan_amount').addEventListener('input', Annuitaeten.changeToMonth);
            Annuitaeten.changeToMonth();
        }

        s();
        var form = document.getElementById('kunden_edit_form');
        for (var i = 0; i < form.children[1].children[3].children[0].children.length; i++) {
            if (form.children[1].children[3].children[0].children[i].children[1] != undefined) {
                form.children[1].children[3].children[0].children[i].children[1].children[0].addEventListener('input', Annuitaeten.changeToMonth)
            }
        }
    });
</script>
