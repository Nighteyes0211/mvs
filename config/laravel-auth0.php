...
return array(
    ...
    |
    */
    'domain'        => env( 'voyagermvs.eu.auth0.com' ),
    ...
    |
    */
    'client_id'     => env( 'zOnNRBlFzzyLhlT9yctnWaUjR1f0lhEx' ),
    ...
    |
    */
    'client_secret' => env( 'JPFi_gN-BFO5MVytbHI9sGJG1ZeHkXPWX4BN_QJMR_ufOnVBAarBBLd7jbdmdHJ_' ),
    ...
    */
    ...
    |
    */
    'authorized_issuers'  => [ env( 'voyagermvs.eu.auth0.com' ) ],
